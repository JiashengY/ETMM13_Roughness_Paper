...
Thus, the augmentation of heat transfer of a rough wall can be characterized by an analogous term to roughness function $\Delta U^+$, i.e. $\Delta \Theta^+$.
...
At the moment, no universal predictive model for the aforementioned quantities is found.
