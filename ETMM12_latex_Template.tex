...
Furthermore, $\Delta U^+=\sqrt{2/C_{fs}}-\sqrt{2/C_{fr}}$ gives direct relation between roughenss function and skin friction (Hama 1954), where $C_{fs}$, $C_{fr}$ are the skin friction coefficients for smooth and rough wall at matched $Re_\tau$ respectively.
...
%\end{figure}
    \begin{table*}[h]
        ...
        \begin{tabular}{cccccccc|cc}
            ...
            $P1M$ & $0.48$ & $-1$ &0.046&0.0208&0.056&0.28&0.55&7.28&4.72\\[2pt]
            $P2F$ & $0.48$ & $-2 $&0.046&0.0208&0.100&0.21&0.44&6.99&3.93\\
            $P2M$ & $0.48$ & $-2 $&0.046&0.0208&0.110&0.20&0.40&6.86&4.37\\[2pt]
            ...
            $N1M$ & $-0.48$ & $-1$&0.074&0.0208&0.056&0.28&0.55&6.07&4.68\\[2pt]
...
DNS is carried out for fully developed turbulent flow over artificial irregular roughness at $Re_\tau\approx 500$.
...
3 types of roughness PDF, namely $Sk=-0.48$, $0$, $0.48$ are combined with 2 types of power-law roughness PS whose slope $p=-1$\& $-2$.
...
It is found that the influence of roughness is different for $\Delta U^+$ and $\Delta\Theta^+$.
A monotonically increase of $\Delta U^+$ as a function of $Sk$ is observed, while for temperature field the skewed roughness -- regardless peak or pit dominant -- can enhance the temperature offset $\Delta\Theta^+$ to an comparable extent relative to non-skewed roughness given identical PS.
Parallel increases of $\Delta U^+$ and $\Delta\Theta^+$ for different types of roughness can be observed with increasing ES.
